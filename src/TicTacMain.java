        ...
        do {
            ...
            do {
                do {
                    ...
                    row = TeachersSafeInput.SafeInput.getRangedInt(in, "Enter row: ", 1, 3);
                    col = TeachersSafeInput.SafeInput.getRangedInt(in, "Enter col: ", 1, 3);
                    row--;
                    col--;
            ...
            finished = TeachersSafeInput.SafeInput.getYNConfirm(in, "Are you done finished playing? ");
